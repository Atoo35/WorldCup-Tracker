...
//
//    // ✅ FIX: single stable calendar (NO device timezone)
//    private static let matchCalendar: Calendar = {
//        var cal = Calendar(identifier: .gregorian)
//        cal.timeZone = TimeZone(secondsFromGMT: 0)! // GMT is source of truth
//        return cal
//    }()
//
//    init() {
...
//                errorMessage = "Could not load matches. Check your connection and try again."
//            } else {
//                errorMessage = "Update failed. Showing last saved data."
//            }
//        }
//    }
//
...
//
//        todayMatches = matches.filter { match in
//            guard let date = match.kickoffDate else { return false }
...
//        }
//
//        tomorrowMatches = matches.filter { match in
//            guard let date = match.kickoffDate else { return false }
...
//}
//
//private enum MatchServiceError: Error {
